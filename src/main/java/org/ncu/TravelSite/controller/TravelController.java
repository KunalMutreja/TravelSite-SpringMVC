...
public class TravelController {
	 ...
	 @Autowired
		private TravelDao travelDao;
	  	...
	  	public String viewId(@Valid @RequestParam("search")String TravelTitle,Travel travel, Model model) {
	 ...
	 // Login and registration
	  	...
	  	public String registerForm(@Valid @ModelAttribute("user")User user, BindingResult br)
	  	{
	  		if(br.hasErrors())
	  		{
	  			return "travel";
	    ...
	    public String Register(@Valid @ModelAttribute("user") User user,HttpSession session ,Model model,HttpServletRequest request, BindingResult br)
	    {
	    	if(br.hasErrors())
	  		{
	  			return "travel";
